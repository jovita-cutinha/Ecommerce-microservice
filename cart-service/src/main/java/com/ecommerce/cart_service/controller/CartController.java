...
public class CartController {
    ...
    public ResponseEntity<ApiResponseDTO> increaseItemQuantity(@PathVariable Long itemId,
    ...
    public ResponseEntity<ApiResponseDTO> decreaseItemQuantity(@PathVariable Long itemId,
                                                               @RequestParam(defaultValue = "1") int amount,
                                                               JwtAuthenticationToken principal) {
        return ResponseEntity.ok(cartService.updateItemQuantity(principal, itemId, -amount));
    }
